...
#    logPath        = "/home/l2mcgrat/MBPolPaperN8/output_files/"+job_name
	...
	exe_file       = "time $HOME/.mmtk/bin/python2.7 PolSimStart.py /scratch/l2mcgrat/d/H2O_T"+str(T)+"P10.rho /scratch/l2mcgrat/d/H2O_T"+str(T)+"P10.eng /scratch/l2mcgrat/d/H2O_T"+str(T)+"P10.esq "+str(S)+" "+str(R)+" 1"
