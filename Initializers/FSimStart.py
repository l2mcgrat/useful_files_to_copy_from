...
cosfile1 = open("cosfile1-"+str(nmolecules)+"H20T"+str(temperature)+"P"+str(P)+"R"+str(lattice_spacing)+"FileFVersion"+str(numsteps)+"Steps"+label,"w")
cosfile2 = open("cosfile2-"+str(nmolecules)+"H20T"+str(temperature)+"P"+str(P)+"R"+str(lattice_spacing)+"FileFVersion"+str(numsteps)+"Steps"+label,"w")
dihedral = open("dihedral-"+str(nmolecules)+"H20T"+str(temperature)+"P"+str(P)+"R"+str(lattice_spacing)+"FileFVersion"+str(numsteps)+"Steps"+label,"w")
